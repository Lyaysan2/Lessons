...
public class SceneEndChecker {
    ...
    public static boolean moveAcceptable(Student student, Direction direction) {
        final Bounds worldBounds = Game.instance.getGamingPane().getLayoutBounds();
        final Bounds tankBounds = student.getBoundsInParent();
        double indent = 1;
        ...
        for (GameObject collision: collisionList) {
            if (collision.equals(student)) { continue; }
